  ...
  return (
    <div>
      <Nav/>
       ...
       {!myShopData && (
        <div className='flex justify-center items-center p-4 sm:p-6 mt-30'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              <FaUtensils size={25} className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20' />
              <h2 className='text-xl font-semibold mt-4'>Add Your Restaurant</h2>
      ...
      {myShopData && 
      <div className="w-full flex flex-col items-center gap-6 px-4 sm:px-6 mt-37">
  <h1 className="text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 text-center">
  ...
  <div>
    {myShopData.items.length===0 && <div className='flex justify-center items-center p-4 sm:p-6 '>
          <div className='w-full max-w-md bg-white shadow-lg rounded-xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              <FaUtensils size={25} className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20' />
              <h2 className='text-xl font-semibold mt-4'>Add Your Food Item</h2>
