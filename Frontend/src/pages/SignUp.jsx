...
const SignUp = () => {
  ...
  return (
    ...
    <div className="mb-4">
      ...
      <input type="number" placeholder="enter your mobile number" value={mobile}
    ...
    <button
      ...
      style={
        role === r
          ...
          : { backgroundColor: 'white', color: '#333', border: `1px solid ${borderColor}` }
      }
    >
  ...
  bg-[#ff4d2d] hover:bg-[#e64323] text-white">
        ...
        <p className='text-center mt-4'>Already have an account? <span className="cursor-pointer text-[#ff4d2d]" onClick={()=>navigate('/signin')}>SignIn</span></p>
    </div>
